...
\title{Experimental Controls System}

\author{James Nikkel\thanks{james.nikkel@rhul.ac.uk} \\
...
\texttt{svn co svn://clean.physics.yale.edu/SC\_backend}
